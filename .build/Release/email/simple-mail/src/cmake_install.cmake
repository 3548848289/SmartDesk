# Install script for directory: D:/CxxProgram/SmartDesk/email/simple-mail/src
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "devel" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE STATIC_LIBRARY OPTIONAL FILES "D:/CxxProgram/SmartDesk/.build/Release/email/simple-mail/src/libSimpleMail3Qt6.dll.a")
endif()

if(CMAKE_INSTALL_COMPONENT STREQUAL "runtime" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE SHARED_LIBRARY FILES "D:/CxxProgram/SmartDesk/.build/Release/email/simple-mail/src/libSimpleMail3Qt6.dll")
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "devel" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/include/simplemail3-qt6/SimpleMail" TYPE FILE FILES
    ...
    "D:/CxxProgram/SmartDesk/email/simple-mail/src/mimemultipart.h"
    "D:/CxxProgram/SmartDesk/email/simple-mail/src/mimepart.h"
    "D:/CxxProgram/SmartDesk/email/simple-mail/src/mimetext.h"
    "D:/CxxProgram/SmartDesk/email/simple-mail/src/quotedprintable.h"
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/pkgconfig" TYPE FILE FILES "D:/CxxProgram/SmartDesk/.build/Release/email/simple-mail/src/SimpleMail3Qt6.pc")
endif()
